# -*- coding: utf-8 -*-
#
# pytest-pact documentation build configuration file, created by
...
project = u'pytest-pact'
copyright = u'2015, Dave Gallant'
author = u'Dave Gallant'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-pact Documentation',
     [author], 1)
]
